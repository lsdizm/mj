...
public class Scheduler : IScheduler
{
    ...
    private async Task PostAsyncApi()
    {
        ...
        var result = await _dataapi.GetRaceResultDetail(rc_date_fr, rc_date_to).ConfigureAwait(false);
